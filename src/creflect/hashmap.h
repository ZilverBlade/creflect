...
CREFLECT_API void* crf_fixed_hashmap_insert(crf_fixed_hashmap map, const void* key, void* value);
CREFLECT_API crf_bool crf_fixed_hashmap_remove(crf_fixed_hashmap map, const void* key);
CREFLECT_API void* crf_fixed_hashmap_get_ptr(crf_fixed_hashmap map, const void* key);
